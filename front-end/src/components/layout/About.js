...
const About = () => {
  return (
    <div className="container">
      <h4 className="center white-text">Check the crowd level of your favourite study areas before going there!</h4>
      ...
      <footer>
        <h6 style={{paddingTop:250}}className="yellow-text center">Hack n Roll 2020</h6>
      </footer>
